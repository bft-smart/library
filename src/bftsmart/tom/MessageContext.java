...
public class MessageContext implements Serializable {
    ...
    public MessageContext(int sender, int viewID, TOMMessageType type,
            ...
            Set<ConsensusMessage> proof, TOMMessage firstInBatch, boolean noOp, byte[] metadata) {
   ...
   /**
    ...
    public TOMMessage recreateTOMMessage(byte[] content) {
        //****** ROBIN BEGIN ******//
        TOMMessage ret = new TOMMessage(sender, session, sequence, operationId, metadata, content, null,
                viewID, type);
        //******* ROBIN END ******//
