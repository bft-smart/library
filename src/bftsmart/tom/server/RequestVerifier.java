 ...
 * in order to enforce the "external validity" property, i.e,
 * to verify if the requests are valid in accordance to the
 * application semantics (and not an erroneous requests sent by
 * a Byzantine leader).
 * 
 * @author joao
 */
