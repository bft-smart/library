 ...
 */
public final class StrongBlockchainServer extends StrongBlockchainRecoverable {
    ...
    public StrongBlockchainServer(int id, int interval, int replySize, int stateSize, boolean context, boolean prettyPrint, int signed, int write) {
    ...
    public byte[][] appExecuteBatch(byte[][] commands, MessageContext[] msgCtxs, boolean fromConsensus) {
        ...
        if (randomAccessFile != null) {
            ...
            try {
                ...
                Logger.getLogger(StrongBlockchainServer.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String[] args){
        ...
        new StrongBlockchainServer(processId,interval,replySize, stateSize, context, prettyPrint, s, w);        
    }
