 ...
 */
public final class WeakBlockchainServer extends WeakBlockchainRecoverable {
    ...
    public WeakBlockchainServer(int id, int interval, int replySize, int stateSize, boolean context, boolean prettyPrint, int signed, int write) {
    ...
    public byte[][] appExecuteBatch(byte[][] commands, MessageContext[] msgCtxs, boolean fromConsensus) {
        ...
        if (randomAccessFile != null) {
            ...
            try {
                ...
                Logger.getLogger(WeakBlockchainServer.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String[] args){
        ...
        new WeakBlockchainServer(processId,interval,replySize, stateSize, context, prettyPrint, s, w);        
    }
