...
public class LVClient
{
	...
	private static boolean createTable(BFTList bftMap, String nameTable) throws Exception
	{
		boolean tableExists;
	...
	private static boolean insertValue(BFTList bftMap, String nameTable) throws Exception
	{
